 ...
 */
public class SearchSlots extends JFrame {
    ...
    public SearchSlots(Controller controller) {
        ...
        //if it is the request comes from the user page, it runs this,
            ...
            String[] columnNames = {"Number ", "Day","Time"};
            String[][] data = model.searchSlots(1);
            ...
            textTf1.setText("The following slots were found");
            textTf2.setText("Please enter the slot number. ");
