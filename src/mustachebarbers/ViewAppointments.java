...
public class ViewAppointments extends JFrame {
    ...
    public ViewAppointments(Controller controller) {
        ...
        cancel.setActionCommand("ViewAppointments Cancel");
        logout.addActionListener(controller);
        logout.setActionCommand("ViewAppointment Logout");
        back.setActionCommand("ViewAppointment Back");
